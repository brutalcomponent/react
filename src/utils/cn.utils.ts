...
export const getAccentClasses = (accentColor: string = 'brutal-pink') => {
  ...
  return brutalAccentClasses[normalizedColor as keyof typeof brutalAccentClasses] 
    || brutalAccentClasses['brutal-pink']; // fallback
};
...
export const createBrutalClasses = (options: {
  accent?: string;
  size?: BrutalSize;
